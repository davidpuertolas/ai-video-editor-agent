...
import { EDIT_OBJECT, LAYER_SELECTION } from "@designcombo/state";
import {
  SelectionInfo,
  emptySelection,
  getSelectionByIds,
...
export function SceneInteractions({
  ...
  const handleSelection = (ids: string[]) => {
    console.log("[DEBUG Interactions] Selección de elementos:", ids);
    ...
    if (ids && ids.length === 1) {
      ...
      setTimeout(() => {
        ...
        console.log("[DEBUG Interactions] Panel después del cambio:", currentMenuItem);
      }, 100);
    }
  };
